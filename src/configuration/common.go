...
const (
	...
	sonarQubeAdminSecretDev   = "SONARQUBE_ADMIN_SECRET_DEV"
	sonarQubeAdminSecretQA    = "SONARQUBE_ADMIN_SECRET_QA"
	sonarQubeAdminSecretPROD  = "SONARQUBE_ADMIN_SECRET_PROD"
	sonarQubeAdminSecretLocal = "SONARQUBE_ADMIN_SECRET_LOCAL"
)
